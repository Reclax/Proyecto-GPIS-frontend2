...
function FavoritosPage() {
  ...
  const fetchFavoritos = async () => {
    try {
      ...
      const mappedFavoritos = await Promise.all(
        favoritesData.map(async (favorite) => {
          ...
          try {
            ...
            if (
              fullProductData.ProductPhotos &&
              Array.isArray(fullProductData.ProductPhotos) &&
              fullProductData.ProductPhotos.length > 0
            ) {
              const sortedPhotos = fullProductData.ProductPhotos.sort(
      ...
      onConfirm: async () => {
        try {
          ...
          setModalData({
            ...
            message:
              "El producto ha sido eliminado de tus favoritos exitosamente.",
    ...
    setModalData({
      ...
      onConfirm: async () => {
        try {
          ...
          const deletePromises = favoritos.map((fav) =>
            favoriteAPI.removeFavorite(fav.productId)
          );
        ...
        {favoritos.length > 0 ? (
            ...
            {favoritos.map((producto) => (
              ...
              >
                ...
                <div className="relative aspect-square bg-gradient-to-br from-gray-50 to-gray-100 flex items-center justify-center text-8xl">
                  ...
                  <button
                    onClick={() =>
                      eliminarFavorito(producto.id, producto.titulo)
                    }
                ...
                <div className="p-4">
                  ...
                  <p className="text-sm text-gray-500 mb-2">
                    Vendido por:{" "}
                    <span className="font-semibold">{producto.vendedor}</span>
                  </p>
                  <p className="text-sm text-gray-500 mb-4">
                    Guardado el{" "}
                    {new Date(producto.fechaGuardado).toLocaleDateString(
                      "es-EC",
                      {
                        year: "numeric",
                        month: "short",
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Explora productos y guarda los que te interesen
            </p>
            <Link
              to="/productos"
