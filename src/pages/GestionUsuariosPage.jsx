...
function GestionUsuariosPage() {
  ...
  const toggleUserStatus = async (user) => {
    ...
    setModalData({
      ...
      message: `¿Estás seguro de que deseas ${action} la cuenta de ${
        user.nombre
      } ${user.apellido}?${
        action === "suspender"
      ...
      onConfirm: async () => {
        try {
          ...
          setModalData({
            ...
            title: "Éxito",
            message: `Usuario ${
              action === "suspender" ? "suspendido" : "activado"
            } correctamente. El usuario ha sido notificado.`,
            confirmText: "Entendido",
          });
      ...
      <div className="sb-container max-w-7xl">
        ...
        <div className="mb-6">
          ...
          <p className="text-gray-600 mt-1">
            Administra y supervisa las cuentas de usuarios de la plataforma
          </p>
        </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 pt-6 border-t border-gray-200">
            ...
            <div className="text-center">
              <p className="text-2xl font-bold text-purple-600">
                {usuarios.filter((u) => u.rol === "Moderador").length}
              </p>
                      ...
                      {user.rol !== "Moderador" ? (
                        <div className="text-sm">
                          <p className="text-gray-900 font-semibold">
                            {user.total_productos} productos
                          </p>
          ...
          <div className="bg-white rounded-xl shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            ...
            <div className="sticky top-0 bg-gradient-to-r from-orange-500 to-orange-600 text-white px-6 py-4 flex items-center justify-between">
              <h2 className="text-xl font-bold flex items-center gap-2">
                <FiUser /> Detalles de {selectedUser.nombre}{" "}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div className="bg-yellow-50 rounded-lg p-4 text-center">
                      <p className="text-3xl font-bold text-yellow-600 flex items-center justify-center gap-1">
                        ...
                        {selectedUser.rating_promedio || "N/A"}
                      </p>
